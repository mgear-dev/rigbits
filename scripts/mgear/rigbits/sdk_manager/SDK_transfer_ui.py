...
class SDK_transfer(QtWidgets.QDialog):
	...
	def create_menu_bar_actions(self):
		...
		"""
		# File
		self.export_settings_action = QtWidgets.QAction("Export settings", self)
		self.import_settings_action = QtWidgets.QAction("Import settings", self)
	...
	def create_connections(self):
		...
		self.ui.addSourceDriver_pushButton.clicked.connect(partial(self.add_driver, self.ui.source_treeWidget, True))
		self.ui.addDestinationDriver_pushButton.clicked.connect(partial(self.add_driver, self.ui.destination_treeWidget, False))
	...
	def add_children(self, item):
		...
		connectedSDK_ctls = sdk_m.getDrivenFromAttr(driverCtl.attr("translateY"), is_SDK=False)
...
if __name__ == "__main__":
	...
	uiPath = r"C:\Users\Justi\OneDrive\Documents\maya\mGear\scripts\mgear\rigbits\SDK_manager\SDK_transfer.ui"
	sdk_transfer_dialog = SDK_transfer(uiPath)
